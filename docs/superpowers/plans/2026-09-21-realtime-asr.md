...
- [x] Verify official protocol and live provider with synthetic speech; never assume incremental response semantics.
- [x] Test and implement stream protocol, error handling, terminal packet and cancellation.
- [x] Add isolated SQLite preview state and authenticated API with explicit staleness.
- [x] Add bounded FFmpeg live reader, room filtering, reconnect, watchdog and shutdown.
- [x] Configure optional Compose service/internal RTSP and document operational limits.
- [x] Run unit and real stream checks, code review, push/deploy and verify health.
